...
export const ChatWithIcon = () => (
  <Chat 
    icon 
    username={ text("UserName", "hlnlapookie") }
    message={ text("Message", "Hello, this is my version with an icon before my username") }
  />
);
...
export const ChatWithMention = () => (
  <Chat 
    username={ text("UserName", "hlnlapookie") }
    message={ text("Message", "Hello, this is my version with an user mentioned in my message's content") }
...
export const ChatFull = () => (
  <Chat
    ...
    icon
    username={ text("UserName", "hlnlapookie") }
    message={ text("Message", "Hello, this is my version with an user mentioned in my message content") }
    mention={ text("Mention", "tutur") }
  />
);
